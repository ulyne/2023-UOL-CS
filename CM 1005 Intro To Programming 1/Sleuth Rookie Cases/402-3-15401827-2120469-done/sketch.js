...
Officer: 2120469
CaseNum: 402-3-15401827-2120469
...
function draw()
{
	...
	if (det.locationY > 509 && det.locationX > 751)
	{
		det.speedX = 0;
		det.speedY = -1;
	}else if (det.locationY == 509 && det.locationX > 751){
        det.speedX = -1;
        det.speedY = 0;
    }else if (det.locationY == 509 && det.locationX < 200){
        det.speedX = 0;
        det.speedY = -1;
    }else if (det.locationY == 386 && det.locationX < 380){
        det.speedX = 1;
        det.speedY = 0;
    }else if (det.locationY == 386 && det.locationX == 570){
        det.speedX = 0;
        det.speedY = -1;
    }else if (det.locationY == 260 && det.locationX == 570){
        det.speedX = -1;
        det.speedY = 0;
    }else if (det.locationY == 260 && det.locationX == 320){
        det.speedX = 0;
        det.speedY = -1;
    }else if (det.locationY == 130 && det.locationX == 320){
        det.speedX = 1;
        det.speedY = 0;
    }else if (det.locationY == 130 && det.locationX == 825){
        det.speedX = 0;
        det.speedY = -1;
    }else if (det.locationY == 70 && det.locationX > 130){
        det.speedX = -1;
        det.speedY = 0;
    }else if (det.locationY == 70 && det.locationX == 130){
        det.speedX = 0;
